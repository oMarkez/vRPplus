...
vRP.registerMenuBuilder("main", function(add, data)
  ...
  local choices = {}
  if vRP.hasPermission(user_id, "player.phone") and vRP.getHealth(user_id) > 120 and vRP.hasInventoryItem(user_id, "phone") or vRP.hasInventoryItem(user_id, "phone2") then
